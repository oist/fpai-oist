...
public class AdvancedBatteryDeviceModelTest {
    ...
    public void testGetChargeEfficiency() {
        ...
        assertEquals(97.1002,
                     model.getChargeEfficiency(
                                               Measure.valueOf(.5 * model.getMaximumChargeSpeed()
                                                                         .doubleValue(SI.WATT),
                                                               SI.WATT)),
                     0.0001);
    }
    ...
    public void testGetDischargeEfficiency() {
        ...
        // Efficiency at half speed
        assertEquals(94.9225486,
                     model.getDischargeEfficiency(
                                                  Measure.valueOf(.5 * model.getMaximumDischargeSpeed()
                                                                            .doubleValue(SI.WATT),
                                                                  SI.WATT)),
                     0.0001);
    }
